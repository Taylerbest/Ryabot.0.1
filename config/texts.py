...
ISLAND_MAIN_MENU = """
🏝 WELCOME TO THE ISLAND ℹ️
                  
💠 ВСЕГО ДОБЫТО: {total_rbtc_mined}
...
🔥[💠] Сожжено: {total_burned_rbtc:.2f} (~{burn_percentage:.4f}%)
"""
...
# === КВАНТХАБ ===
BTN_LAB_EQUIPMENT = "⚛️ Лаб. Оборудование"
QUANTUMHUB_MENU = '''〰️〰️ 🖥 КВАНТХАБ ℹ️ 🔋{energy} 〰️〰️
...
# === QUANTUM PASS ===
BTN_QUANTUM_PASS = "🪪 Квантовый Пропуск"
QPASS_MENU = """〰️〰️ 🪪 Q-PASS ℹ️ 〰️〰️

📊 Игроки с пропуском: {total_active_qpass_users}
...
⏳ Время действия Q-Pass: {time_left}"""


# =============================================================================
# TOWN HALL TEXTS - Тексты для ратуши
# =============================================================================

TOWN_HALL_TEXTS = {
    "main_menu": """〰️〰️ 🏛 РАТУША ℹ️ [🔋{energy}] 〰️〰️
...
«Суровое сердце острова Рябот, где судьбы вершатся с помощью печатей на документах. Здесь выдаются лицензии, взимаются налоги, а амбициозные фермеры отстаивают свои интересы».""",
    ...
    "licenses_menu": """〰️ 📜 БЮРО ЛИЦЕНЗИЙ ℹ️ 〰️
...
💰 Мультипликатор рябаксов: x{ryabucks_mult}
⚛️ Мультипликатор RBTC: x{rbtc_mult}""",

    "my_office": "🚧 Личный кабинет в разработке",
    "tasks": "🚧 Система поручений в разработке",
    "rewards": "🚧 Система наград в разработке",
    "guilds": "🚧 Система гильдий в разработке",
    "daily_bonuses": "🚧 Ежедневные бонусы в разработке",
    "license_maxed": "Лицензия уже максимального уровня! 🎉"
}
