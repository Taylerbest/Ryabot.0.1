...
class BlockchainService:
    ...
    def __init__(self):
        self.client = None
        self.bot = None  # Будет установлен в main.py
        ...
        try:
            ...
            try:
                if settings.HISTORY_CHANNEL_ID:
                    ...
                    blockchain_msg = await self.bot.send_message(
                    ...
                    logger.info(f"✅ Лог отправлен в @history: {action_type}")
            ...
            try:
                if significance >= 2 and settings.ISLAND_CHANNEL_ID:
                    ...
                    logger.info(f"✅ Празднование отправлено в @island: {action_type}")
